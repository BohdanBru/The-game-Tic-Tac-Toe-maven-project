...
package root.model.config;

import root.logic.ComputerMoveStrategy;
import root.logic.strategy.*;

public enum LevelOfDifficult {
    FIRST(new ComputerMoveStrategy[]{new FirstMoveToTheCenterComputerMoveStrategy(),
            new RandomComputerMoveStrategy()}),
    SECOND(new ComputerMoveStrategy[]{new WinNowComputerMoveStrategy(),
            new PreventUserWinComputerMoveStrategy(),
            new FirstMoveToTheCenterComputerMoveStrategy(),
            new RandomComputerMoveStrategy()}),
    THIRD(new ComputerMoveStrategy[]{new PreventUserWinComputerMoveStrategy(),
    ...
    LevelOfDifficult(final ComputerMoveStrategy[] strategies) {
